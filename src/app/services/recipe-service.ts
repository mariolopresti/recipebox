  ...
  recipies = signal<Recipe[]>([
    {
      ...
      difficolta: 'Media',
      immagine: 'https://www.mamablip.com/storage/Traditional-Spaghetti-alla-Carbonara_1131611747132.jpg',
      descrizione: 'La carbonara è uno dei primi piatti più famosi della cucina romana. È preparata con spaghetti conditi con una crema di uova, pecorino romano e pepe nero, arricchiti dal guanciale croccante. Non prevede panna ed è amata per il suo sapore intenso e la sua cremosità naturale.',
...

    {
      ...
      difficolta: 'Media',
      immagine: 'https://www.sicucina.it/wp-content/uploads/2025/09/Lasagne-alla-Bolognese-Ricetta-Classica-Emblema-della-Tradizione-Italiana.jpg',
      descrizione: 'Le lasagne alla bolognese sono un grande classico della cucina italiana. Sono composte da strati di pasta all’uovo alternati con ragù di carne, besciamella cremosa e parmigiano. Durante la cottura in forno si crea una crosticina dorata e saporita.',
...

    {
      ...
      difficolta: 'Media',
      immagine: 'https://assets-eu-01.kc-usercontent.com/6190ffc3-df26-019e-e092-120e0715df95/9c076f13-af22-410c-876d-7986dd243846/Pizza%20margherita.png?w=626&fm=webp&lossless=0&q=80',
      descrizione: 'La pizza margherita è una delle pizze più famose al mondo. È caratterizzata da ingredienti semplici: pomodoro, mozzarella e basilico. I colori ricordano la bandiera italiana e rappresentano la tradizione della pizza napoletana.',
...

    {
      ...
      descrizione: 'Il risotto ai funghi è un piatto cremoso tipico della cucina del nord Italia. Il riso viene cotto lentamente con brodo caldo e funghi saltati. Alla fine viene mantecato con burro e parmigiano per ottenere una consistenza morbida.',
...

    {
      ...
      difficolta: 'Facile',
      immagine: 'https://www.tavolartegusto.it/wp/wp-content/uploads/2017/07/Insalata-Caprese-Ricetta-originale-Insalata-Caprese-pomodori-e-mozzarella-.jpg',
      descrizione: 'La caprese è un piatto fresco e leggero tipico della cucina mediterranea. È preparato con pomodori maturi, mozzarella fresca e basilico. È ideale come antipasto o piatto estivo veloce.',
...

    {
      ...
      difficolta: 'Media',
      immagine: 'https://www.cucchiaio.it/content/cucchiaio/it/ricette/2015/11/pollo-al-curry/jcr:content/imagePreview.img10.jpg/1620744313759.jpg',
      descrizione: 'Il pollo al curry è un piatto speziato tipico della cucina asiatica. Il pollo viene cotto con curry e latte di cocco creando una salsa cremosa e profumata. Di solito si serve con riso bianco.',
...

    {
      ...
      difficolta: 'Facile',
      immagine: 'https://images-tastehub.mdlzapps.cloud/images/017bedd0-06c9-4461-9eb1-8eb59b50e493.jpg',
      descrizione: 'L’hamburger è uno dei panini più diffusi al mondo. Consiste in un disco di carne macinata cotto alla griglia e servito in un panino morbido con verdure e formaggio.',
...

    {
      ...
      difficolta: 'Media',
      immagine: 'https://www.bunsenburnerbakery.com/wp-content/uploads/2016/06/easy-tiramisu-square-29-720x405.jpg',
      descrizione: 'Il tiramisù è uno dei dolci italiani più conosciuti al mondo. È composto da strati di savoiardi imbevuti nel caffè e crema al mascarpone.',
...

    {
      ...
      difficolta: 'Facile',
      immagine: 'https://www.giallozafferano.it/images/243-24387/Pancakes-allo-sciroppo-d-acero_650x433_wm.jpg',
      descrizione: 'I pancake sono soffici frittelle tipiche della colazione americana. Vengono serviti con sciroppo d’acero, frutta o miele.',
...

    {
      ...
      immagine: 'https://images.immediate.co.uk/production/volatile/sites/30/2024/01/California-roll-a87199c.jpg',
      descrizione: 'I sushi rolls sono rotoli di riso avvolti in alga nori tipici della cucina giapponese. Possono contenere pesce, verdure o avocado.',
...

    {
      ...
      tempoPreparazione: 60,
      difficolta: 'Difficile',
      immagine: 'https://www.cucchiaio.it/content/dam/cucchiaio/it/ricette/2013/07/ricetta-paella-pesce/Paella%20di%20pesce_orizz.jpg',
      descrizione: 'La paella è un piatto tipico spagnolo ricco di riso, carne e frutti di mare. È cucinata in una larga padella chiamata paellera.',
...

    {
      ...
      descrizione: 'La zuppa di lenticchie è un piatto caldo e nutriente molto diffuso nella cucina mediterranea. È ricca di proteine vegetali.',
...

    {
      ...
      tempoPreparazione: 20,
      difficolta: 'Facile',
      immagine: 'https://i0.wp.com/www.piccolericette.net/piccolericette/wp-content/uploads/2015/11/1312_frittata.jpg',
      descrizione: 'La frittata di verdure è un piatto semplice e veloce, ideale per un pranzo leggero o una cena rapida.',
...

    {
      ...
      tempoPreparazione: 25,
      difficolta: 'Media',
      immagine: 'https://qbcucina.com/cdn/shop/articles/img-1713808789633_a37501db-2cb5-404a-9bff-eed4f8c45977_1200x.png?v=1713810591',
      descrizione: 'Gli gnocchi al pesto sono un primo piatto tipico ligure. Gli gnocchi di patate vengono conditi con pesto di basilico fresco.',
...

    {
      ...
      difficolta: 'Media',
      immagine: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkZ-eRmOj0iEwJhsfYfOEOgO3FxbQ0MHti-w&s',
      descrizione: 'La cheesecake ai frutti di bosco è un dolce cremoso con base di biscotti e burro. È completata con una salsa di frutti di bosco.',
