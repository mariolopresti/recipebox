...
export class RecipeService {
  ...
  recipies = signal<Recipe[]>([
    ...
    },
    {
      ...
      preparazione:
        'Ingredienti per 4 persone: 250 g di sfoglie di lasagne, 500 g di ragù alla bolognese, 500 ml di besciamella, 80 g di parmigiano. In una teglia stendi besciamella, pasta, ragù e parmigiano. Ripeti gli strati fino a terminare gli ingredienti. Cuoci in forno a 180°C per circa 30 minuti.',
    },
    {
      id: 3,
      ...
      preparazione:
        'Ingredienti per 2 pizze: 500 g farina 00, 300 ml acqua, 3 g lievito, 10 g sale, 200 g mozzarella, 200 g pomodoro. Impasta farina, acqua e lievito, aggiungi sale e lascia lievitare 2 ore. Stendi l’impasto, aggiungi pomodoro e mozzarella e cuoci a 250°C per 10 minuti. Completa con basilico.',
    },
    {
      id: 4,
      ...
      preparazione:
        'Ingredienti per 2 persone: 180 g riso arborio, 200 g funghi porcini, 1 l brodo, 30 g burro, 40 g parmigiano, 1/2 cipolla. Soffriggi la cipolla, aggiungi il riso e tostalo. Versa brodo poco alla volta mescolando. A metà cottura unisci i funghi. Manteca con burro e parmigiano.',
    },
    {
      id: 5,
      ...
      preparazione:
        'Ingredienti per 2 persone: 2 pomodori grandi, 200 g mozzarella, basilico fresco, olio extravergine e sale. Taglia pomodori e mozzarella a fette. Disponili alternandoli nel piatto. Condisci con olio, sale e basilico.',
    },
    {
      id: 6,
      nome: 'Pollo al Curry',
      ...
      preparazione:
        'Ingredienti per 2 persone: 300 g petto di pollo, 1 cipolla, 200 ml latte di cocco, 1 cucchiaio curry, 200 g riso. Rosola la cipolla, aggiungi il pollo a cubetti e il curry. Versa il latte di cocco e cuoci 15 minuti. Servi con riso bollito.',
    },
    {
      id: 7,
      ...
      preparazione:
        'Ingredienti per 2 hamburger: 300 g carne macinata, 2 panini, 2 fette formaggio, lattuga e pomodoro. Forma gli hamburger e cuocili in padella o piastra per 4-5 minuti per lato. Scalda il pane e farcisci con carne, formaggio e verdure.',
    },
    {
      id: 8,
      nome: 'Tiramisù',
      ...
      preparazione:
        'Ingredienti: 250 g mascarpone, 200 g savoiardi, 2 uova, 80 g zucchero, 200 ml caffè, cacao amaro. Monta tuorli e zucchero, aggiungi mascarpone e albumi montati. Bagna i savoiardi nel caffè e alterna strati di crema. Spolvera cacao e lascia riposare in frigo.',
    },
    {
      id: 9,
      nome: 'Pancake',
      ...
      preparazione:
        'Ingredienti: 150 g farina, 1 uovo, 200 ml latte, 30 g zucchero, 20 g burro. Mescola gli ingredienti per creare una pastella. Versa piccole quantità in padella imburrata e cuoci 2 minuti per lato.',
    },
    {
      id: 10,
      nome: 'Sushi Rolls',
      ...
      preparazione:
        'Ingredienti: 200 g riso sushi, 3 fogli alga nori, 100 g salmone, 1 avocado. Cuoci il riso e condiscilo con aceto di riso. Stendilo sull’alga, aggiungi ripieno e arrotola con stuoia. Taglia in pezzi.',
    },
    {
      id: 11,
      nome: 'Paella',
      ...
      preparazione:
        'Ingredienti: 300 g riso, 200 g pollo, 200 g frutti di mare, 1 bustina zafferano, 700 ml brodo. Rosola il pollo, aggiungi riso e zafferano, versa il brodo e unisci frutti di mare e piselli. Cuoci finché il riso assorbe il liquido.',
    },
    {
      id: 12,
      ...
      preparazione:
        'Ingredienti: 250 g lenticchie, 1 carota, 1 costa sedano, 1 cipolla, 700 ml brodo. Soffriggi le verdure tritate, aggiungi lenticchie e brodo e cuoci per circa 30 minuti.',
    },
    {
      id: 13,
      ...
      preparazione:
        'Ingredienti: 4 uova, 1 zucchina, 1/2 peperone, 30 g parmigiano, 1/4 cipolla. Salta le verdure in padella. Sbatti le uova con parmigiano e uniscile alle verdure. Cuoci 5-6 minuti per lato.',
    },
    {
      id: 14,
      ...
      preparazione:
        'Ingredienti: 500 g gnocchi, 50 g basilico, 20 g pinoli, 40 g parmigiano, 80 ml olio. Frulla basilico, pinoli, parmigiano e olio per creare il pesto. Cuoci gli gnocchi finché salgono a galla e condiscili.',
    },
    {
      id: 15,
